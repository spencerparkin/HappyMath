...
namespace HappyMath
{
	 ...
	 */
	class HAPPY_MATH_API Matrix4x4
	{
	public:
		Matrix4x4();
	...
	HAPPY_MATH_API Matrix4x4 operator*(const Matrix4x4& leftMatrix, const Matrix4x4& rightMatrix);

	HAPPY_MATH_API Vector4 operator*(const Matrix4x4& leftMatrix, const Vector4& rightVector);

	HAPPY_MATH_API Vector4 operator*(const Vector4& leftVector, const Matrix4x4& rightMatrix);
}