...
void Matrix3x3::GetToQuat(Quaternion& unitQuat) const
{
	...
	unitQuat.w = 0.25 * ::sqrt(HM_SQUARED(r11 + r22 + r33 + 1.0) + HM_SQUARED(r32 - r23) + HM_SQUARED(r13 - r31) + HM_SQUARED(r21 - r12));
	unitQuat.x = 0.25 * ::sqrt(HM_SQUARED(r32 - r23) + HM_SQUARED(r11 - r22 - r33 + 1.0) + HM_SQUARED(r21 + r12) + HM_SQUARED(r31 + r13)) * HM_SIGN(r32 - r23);
	unitQuat.y = 0.25 * ::sqrt(HM_SQUARED(r13 - r31) + HM_SQUARED(r21 + r12) + HM_SQUARED(r22 - r11 - r33 + 1.0) + HM_SQUARED(r32 + r23)) * HM_SIGN(r13 - r31);
	unitQuat.z = 0.25 * ::sqrt(HM_SQUARED(r21 - r12) + HM_SQUARED(r31 + r13) + HM_SQUARED(r32 + r23) + HM_SQUARED(r33 - r11 - r22 + 1.0)) * HM_SIGN(r21 - r12);
}
