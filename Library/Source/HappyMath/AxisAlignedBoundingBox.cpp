...
{
	this->minCorner.x = HM_MAX(aabbA.minCorner.x, aabbB.minCorner.x);
	this->minCorner.y = HM_MAX(aabbA.minCorner.y, aabbB.minCorner.y);
	this->minCorner.z = HM_MAX(aabbA.minCorner.z, aabbB.minCorner.z);

	this->maxCorner.x = HM_MIN(aabbA.maxCorner.x, aabbB.maxCorner.x);
	this->maxCorner.y = HM_MIN(aabbA.maxCorner.y, aabbB.maxCorner.y);
	this->maxCorner.z = HM_MIN(aabbA.maxCorner.z, aabbB.maxCorner.z);
