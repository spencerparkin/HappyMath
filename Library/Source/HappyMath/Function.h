...
namespace HappyMath
{
	...
	class HAPPY_MATH_API RealToVector3Function
	{
	public:
		virtual Vector3 Evaluate(double t) const = 0;
	};

	class HAPPY_MATH_API Vector3ToVector3Function
	{
	public:
	 ...
	 */
	class HAPPY_MATH_API Quadratic : public RealToRealFunction
	{
	public:
		Quadratic();
	 ...
	 */
	class HAPPY_MATH_API Cubic : public RealToRealFunction
	{
	public:
		Cubic();
		virtual ~Cubic();
	 ...
	 */
	class HAPPY_MATH_API QuadraticSpaceCurve : public RealToVector3Function
	{
	public:
		QuadraticSpaceCurve();
	 ...
	 */
	class HAPPY_MATH_API CubicSpaceCurve : public RealToVector3Function
	{
	public:
		CubicSpaceCurve();
