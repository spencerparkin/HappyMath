...
namespace HappyMath
{
	...
	HAPPY_MATH_API Vector4 operator+(const Vector4& leftVector, const Vector4& rightVector);
	HAPPY_MATH_API Vector4 operator-(const Vector4& leftVector, const Vector4& rightVector);
	HAPPY_MATH_API Vector4 operator*(const Vector4& vector, double scalar);
	HAPPY_MATH_API Vector4 operator*(double scalar, const Vector4& vector);
	HAPPY_MATH_API Vector4 operator/(const Vector4& vector, double scalar);
}