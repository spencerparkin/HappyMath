...
{
	this->A = HM_MAX(intervalA.A, intervalB.A);
	this->B = HM_MIN(intervalA.B, intervalB.B);
...
{
	this->A = HM_MIN(intervalA.A, intervalB.A);
	this->B = HM_MAX(intervalA.B, intervalB.B);
}

void Interval::Expand(double value)
{
	this->A = HM_MIN(this->A, value);
	this->B = HM_MAX(this->B, value);
}
