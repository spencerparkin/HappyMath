...
namespace HappyMath
{
	 ...
	 * 
	 */
	class HAPPY_MATH_API GJKTriangleForEPA : public ExpandingPolytopeAlgorithm::Triangle
	{
	public:
		enum Status
		{
	 ...
	 * 
	 */
	class HAPPY_MATH_API GJKPointSupplierForEPA : public ExpandingPolytopeAlgorithm::PointSupplier
	{
	public:
	 ...
	 * 
	 */
	class HAPPY_MATH_API GJKSphere : public GJKShape
	{
	public:
		GJKSphere();
		virtual ~GJKSphere();
	 ...
	 * 
	 */
	class HAPPY_MATH_API GJKConvexHull : public GJKShape
	{
	public:
		GJKConvexHull();
	 ...
	 *
	 */
	class HAPPY_MATH_API GJKSimplex
	{
	public:
		GJKSimplex();
		virtual ~GJKSimplex();
	 ...
	 */
	class HAPPY_MATH_API GJKPointSimplex : public GJKSimplex
	{
	public:
		GJKPointSimplex();
	 ...
	 */
	class HAPPY_MATH_API GJKLineSimplex : public GJKSimplex
	{
	public:
		GJKLineSimplex();
	 ...
	 */
	class HAPPY_MATH_API GJKTriangleSimplex : public GJKSimplex
	{
	public:
		GJKTriangleSimplex();
	 ...
	 */
	class HAPPY_MATH_API GJKTetrahedronSimplex : public GJKSimplex
	{
	public:
