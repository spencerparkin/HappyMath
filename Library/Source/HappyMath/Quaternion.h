...
namespace HappyMath
{
	 ...
	 */
	class HAPPY_MATH_API Quaternion
	{
	public:
		Quaternion();
	...
	HAPPY_MATH_API Quaternion operator+(const Quaternion& quatA, const Quaternion& quatB);
	HAPPY_MATH_API Quaternion operator-(const Quaternion& quatA, const Quaternion& quatB);
	HAPPY_MATH_API Quaternion operator*(const Quaternion& quatA, const Quaternion& quatB);
	HAPPY_MATH_API Quaternion operator/(const Quaternion& quatA, const Quaternion& quatB);
	HAPPY_MATH_API Quaternion operator*(const Quaternion& quat, double scalar);
	HAPPY_MATH_API Quaternion operator*(double scalar, const Quaternion& quat);
	HAPPY_MATH_API Quaternion operator/(const Quaternion& quat, double scalar);
}