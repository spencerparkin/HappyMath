...
namespace HappyMath
{
	 ...
	 */
	class HAPPY_MATH_API Matrix3x3
	{
	public:
		Matrix3x3();
		 ...
		 * 
		 * @param[in] anchorAxis This is one of (not an Or-ing of) the HM_AXIS_FLAG_* defines, and indicates the anchor-axis used for the orthonormalization process.
	 ...
	 */
	HAPPY_MATH_API Matrix3x3 operator+(const Matrix3x3& matrixA, const Matrix3x3& matrixB);
	 ...
	 */
	HAPPY_MATH_API Matrix3x3 operator*(const Matrix3x3& matrix, double scalar);

	/**
	 * See the documentation for the other variation of this function.
	 */
	HAPPY_MATH_API Matrix3x3 operator*(double scalar, const Matrix3x3& matrix);
	 ...
	 */
	HAPPY_MATH_API Vector3 operator*(const Matrix3x3& matrix, const Vector3& vector);
	 ...
	 */
	HAPPY_MATH_API Vector3 operator*(const Vector3& vector, const Matrix3x3& matrix);
}