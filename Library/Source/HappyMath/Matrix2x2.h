...
namespace HappyMath
{
	 ...
	 * often arrise.
	 */
	class HAPPY_MATH_API Matrix2x2
	{
	public:
		Matrix2x2();
	 ...
	 */
	HAPPY_MATH_API Matrix2x2 operator+(const Matrix2x2& matrixA, const Matrix2x2& matrixB);
	 ...
	 */
	HAPPY_MATH_API Matrix2x2 operator*(const Matrix2x2& matrix, double scalar);

	/**
	 * See the documentation for the other variation of this function.
	 */
	HAPPY_MATH_API Matrix2x2 operator*(double scalar, const Matrix2x2& matrix);
	 ...
	 */
	HAPPY_MATH_API Vector2 operator*(const Matrix2x2& matrix, const Vector2& vector);
	 ...
	 */
	HAPPY_MATH_API Vector2 operator*(const Vector2& vector, const Matrix2x2& matrix);
}